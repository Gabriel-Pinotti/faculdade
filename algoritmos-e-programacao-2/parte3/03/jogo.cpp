...
#include <ctime> 
using namespace std;
// includes de bibliotecas próprias
#include "headermenu.h"
//#include "headerposicionamento.h" // TODO criar headerposicionamento.h e funcoesposicionamento.cpp
//#include "headerverificacoes.h" // TODO criar headerverificacoes.h e funcoesverificacoes.cpp
//#include "headermovimentacoes.h" // TODO criar headermovimentacoes.h e funcoesmovimentacoes.cpp
//#include "headermapa.h" // TODO criar headermapa.h e funcoesmapa.cpp
...
bool espacoLivre (int l, int c) { // FIXME verificacoes
...
void pospilulas() { // FIXME psocionamento
    pilulas.clear();
...
void posfantasma() { // FIXME posicionamento
    fantasma.clear();
    vector<posicao> todos = {
...
void posicBomba(){ // FIXME posicionamento
...
template <typename T>
bool temElemento(const vector<T>& v, int l, int c){ // FIXME verificacoes
    for (auto &e : v) {
...
bool temBomba (int l, int c) { // FIXME verificacoes
    return temElemento(bombas, l, c); 
};

bool temPilula (int l, int c) { // FIXME verificacoes
    return temElemento(pilulas, l, c); 
};

bool temFantasma (int l, int c){ // FIXME verificacoes
    return temElemento(fantasma, l, c);
}

void movjog (char cmd = '-') { // FIXME movimentacoes
...
void movfantasma () { // FIXME movimentacoes
    for (auto &f : fantasma) {
